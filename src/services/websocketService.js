...
class GlobalWebSocketManager extends EventEmitter {
    ...
    async getStructuredInsuranceData(userId, chatId) {
        const query = "Extract insurance data as JSON: {\"policyId\":\"\",\"policyNumber\":\"\",\"status\":\"active\",\"productName\":\"\",\"coveragePeriod\":{\"startDate\":\"\",\"endDate\":\"\"},\"beneficiary\":{\"name\":\"\",\"email\":\"\",\"birthDate\":\"\",\"documentNumber\":\"\",\"residenceCountry\":\"\"},\"duration\":0,\"coverage\":\"\"}. Use actual document values.";
        try {
            const response = await this.sendQuery(userId, chatId, query);
